...
require (
	...
	github.com/rancher/shepherd v0.0.0-20251015044355-8c54bf0aaf31 // rancher/shepherd main commit
...
require (
	...
	github.com/rancher/tests/actions v0.0.0-20250919174847-fba13691aa7b
)
