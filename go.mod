...
require (
	...
	github.com/rancher/tests/actions v0.0.0-20251106210841-34fd94da73b2
...
replace (
	...
	k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20250318190949-c8a335a9a2ff // Use the version that already exists in go.sum
)
