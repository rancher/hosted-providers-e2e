...
func upgradeK8sVersionFromRancherCheck(cluster *management.Cluster, client *rancher.Client, k8sVersion, upgradeToVersion string, csClient *cs.Client, clusterId string) {
